const OTHER = {
    ...
    demos: [
        { title: "Falcon Endpoint Protection Pro demo", type: "Resource Center", blurb: "Public demonstration of Falcon Endpoint Protection Pro.", url: "https://www.crowdstrike.com/resources/demos/demonstration-of-falcon-endpoint-protection-pro/" },
        { title: "Falcon Endpoint Protection Enterprise demo", type: "Resource Center", blurb: "Enterprise-tier endpoint demonstration.", url: "https://www.crowdstrike.com/resources/demos/demonstration-of-falcon-endpoint-protection-enterprise/" },
        { title: "Falcon Endpoint Protection Complete demo", type: "Resource Center", blurb: "Complete-tier endpoint demonstration.", url: "https://www.crowdstrike.com/resources/demos/demonstration-of-falcon-endpoint-protection-complete/" },
        { title: "Use case: true endpoint visibility", type: "YouTube", blurb: "Visibility-focused Falcon use case.", url: "https://www.youtube.com/watch?v=pHxb6EyjhPw" }
    ],
    howto: [
        { title: "Contain an infected system", type: "YouTube", blurb: "Network containment from the Falcon console.", url: "https://www.youtube.com/watch?v=9cM3TsHI56A" },
        { title: "Real Time Response remediation", type: "YouTube", blurb: "Remote investigation and remediation with RTR.", url: "https://www.youtube.com/watch?v=eAQ3P11sfg4" },
        { title: "Configure Falcon Device Control", type: "YouTube", blurb: "USB and peripheral policy setup.", url: "https://www.youtube.com/watch?v=CYnZdztL21k" },
        { title: "Hunt for indicators of compromise", type: "YouTube", blurb: "IOC hunting in Falcon.", url: "https://www.youtube.com/watch?v=_t7n9i-cugg" }
    ],
    tools: [
