const PILLARS = [
    ...
    { id: "ai", label: "AI & Agentic Security", coverage: "native", note: "Charlotte AI (agentic SOC) is native. Falcon Guardian is the AI-application security SKU (AIDR for Workforce was renamed)." },
